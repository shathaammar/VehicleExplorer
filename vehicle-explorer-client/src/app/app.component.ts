...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, MakeSelectorComponent, SpecPlateComponent, YearTypeSelectorComponent, ModelResultsComponent],
...
onModelSelected(modelName: string): void {
  this.selection = { ...this.selection, model: modelName };
}
}